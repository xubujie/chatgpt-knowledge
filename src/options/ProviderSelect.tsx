...
import { getProviderConfigs, ProviderConfigs, ProviderType, saveProviderConfigs, ModelType } from '../config'
...
function ProviderSelect() {
  const query = useSWR('provider-configs', async () => {
    const [config, models] = await Promise.all([getProviderConfigs(), ModelType])
